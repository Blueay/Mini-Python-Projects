...
lake = input("and reach a beautiful lake with crystal water. Do you want to 'swim' or 'wait'?\n").lower()
if lake == "wait":
    print("You discover at the end of the lake a bridge which leads to the castle")
else:
    print("You are attached by a trout. Game Over")

door = input("and enter the castle.In front of you there are 3 big doors in the color 'red', 'green' and 'blue'. Which one do you choose?\n").lower()
